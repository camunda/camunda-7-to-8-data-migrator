...
logic in the existing bean and delegate to it from the adapter. The code checklist defines the
remediation and validation rules. Use this reference shape:
