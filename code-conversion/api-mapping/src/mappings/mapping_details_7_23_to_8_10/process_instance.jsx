					...
					rightEntry: (
						<>
							...
							<p>
								...
								<code>TERMINATED</code> to filter by process
								instance state.
							</p>
						</>
					),
		...
		discontinued: {
			rowInfo: [
				...
				},
				{
					...
					rightEntry: (
						<p>These filters are not available in Camunda 8.10.</p>
					),
				},
				{
					leftEntry: <pre>(string) startedBy</pre>,
					rightEntry: <p>This is not possible in Camunda 8.10.</p>,
				},
				{
					leftEntry: (
						<pre>
