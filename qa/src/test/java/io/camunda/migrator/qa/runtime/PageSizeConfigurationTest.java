...
class PageSizeConfigurationTest extends RuntimeMigrationAbstractTest {
  ...
  public void shouldPerformPaginationForProcessInstances(CapturedOutput output) {
    ...
    assertThat(output.getOut()).contains("Method: #fetchAndProcessHistoricRootProcessInstances, max count: 5, offset: 0, page size: 2");
    assertThat(output.getOut()).contains("Method: #fetchAndProcessHistoricRootProcessInstances, max count: 5, offset: 2, page size: 2");
    assertThat(output.getOut()).contains("Method: #fetchAndProcessHistoricRootProcessInstances, max count: 5, offset: 4, page size: 2");
    Matcher matcher = Pattern.compile("Method: #fetchAndProcessProcessInstances, max count: 1, offset: 0, page size: 2").matcher(output.getOut());
  ...
  public void shouldPaginateMultiLevelProcessModel(CapturedOutput output) {
    ...
    assertThat(output.getOut()).contains("Method: #fetchAndProcessHistoricRootProcessInstances, max count: 1, offset: 0, page size: 2");
    assertThat(output.getOut()).contains("Method: #fetchAndProcessProcessInstances, max count: 3, offset: 0, page size: 2");
  }
