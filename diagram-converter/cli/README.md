...
The `--platform-version` option accepts Camunda 8.9, 8.10, and 8.11 targets.
It defaults to Camunda 8.10, the latest stable target; use 8.11 to target the
next version explicitly.
