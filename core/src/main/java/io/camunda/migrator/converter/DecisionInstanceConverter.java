...
public class DecisionInstanceConverter {
  ...
  public DecisionInstanceDbModel apply(HistoricDecisionInstance decisionInstance,
    ...
    return new DecisionInstanceDbModel.Builder()
        ...
        .state(DecisionInstanceEntity.DecisionInstanceState.UNSPECIFIED) // TODO not stored in C7
        ...
        .decisionType(DecisionInstanceEntity.DecisionDefinitionType.UNSPECIFIED) // TODO would need to check xml?
        .tenantId(StringUtils.isEmpty(decisionInstance.getTenantId()) ? "<default>" : decisionInstance.getTenantId())
